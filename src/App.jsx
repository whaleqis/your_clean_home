...
const services = [
  ...
  },
  {
    ...
    subtitle: "Ախտահանում",
    items: [
      "Մաքրում գոլորշու սարքավորման միջոցով",
      "Մակերեսների ախտահանում բարձր ջերմաստիճանով",
      "Սալիկների և կարերի մաքրում",
      "Լոգասենյակի դժվար հասանելի հատվածների մշակում",
      "Խոհանոցի յուղոտ մակերեսների գոլորշիով մաքրում",
      "Ծորակների, լվացարանի և սանհանգույցի հատվածների մշակում",
      "Դռների բռնակների և հաճախ հպվող մակերեսների ախտահանում",
      "Անկյունների և դժվար հասանելի հատվածների մաքրում",
    ],
  },
  {
    id: "ironing",
